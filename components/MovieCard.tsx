...
const MovieCard = ({ id, poster_path, title, vote_average, release_date }: Movie) => {
  return (
    <Link href={`/movies/${id}`} asChild>
      {/* asChild means that the card inside the link is will be the clickable item */}
      <TouchableOpacity className="w-[30%]">
        <Image
          ...
          resizeMode="cover"
        />
        {/* numberOfLiness={1} is a default prop in reactnative which makes the line be adjustable to a certain lines*/}
